...
while True:
    ...
    if auto_time in [28, 58]:
        ...
        for data_symbol_usdt_list_index in data_symbol_usdt_list:
            ...
            log.logger.debug(
                str("存在天數"+str(len(data_symbol_usdt_list_close_list))))
            data_symbol_usdt_list_close_numpy = np.array(
                data_symbol_usdt_list_close_list)
            log.logger.debug(
                str("收盤價:"+str(data_symbol_usdt_list_close_numpy[-1])))
            if len(data_symbol_usdt_list_close_numpy) >= 5:
                ...
                if data_symbol_usdt_list_close_numpy[-1] <= sma5_numpy[-1]:
                    ...
                    if(len(data_symbol_usdt_list_close_numpy)) >= 7:
                        ...
                        sma7_numpy = talib.SMA(
                            data_symbol_usdt_list_close_numpy, 7)
                ...
                data_symbol_less_than_five_day.append(
                    data_symbol_usdt_list_index)
        ...
        if(len(dat_symbol_usdt_list_sma5_line_dict) >= 0):
            ...
            log.logger.debug(
                str(dat_symbol_usdt_list_sma5_line_dict_tuple_sort))
        log.logger.debug(
        ...
        if(len(dat_symbol_usdt_list_sma7_line_dict) >= 0):
            ...
            log.logger.debug(
                str(dat_symbol_usdt_list_sma7_line_dict_tuple_sort))
        log.logger.debug(
        ...
        if(len(dat_symbol_usdt_list_sma10_line_dict) >= 0):
            ...
            log.logger.debug(
                str(dat_symbol_usdt_list_sma10_line_dict_tuple_sort))
        log.logger.debug(
        ...
        if(len(dat_symbol_usdt_list_sma20_line_dict) >= 0):
            ...
            log.logger.debug(
                str(dat_symbol_usdt_list_sma20_line_dict_tuple_sort))
        log.logger.debug(
        ...
        if(len(dat_symbol_usdt_list_sma25_line_dict) >= 0):
            ...
            fa10_logger.info(
                "\n"+str(dat_symbol_usdt_list_sma25_line_dict_tuple_sort))
        ...
        if(len(dat_symbol_usdt_list_sma99_line_dict) >= 0):
            ...
            fa12_logger.info(
                "\n"+str(dat_symbol_usdt_list_sma99_line_dict_tuple_sort))
            lineNotifyMessage(
                str(dat_symbol_usdt_list_sma99_line_dict_tuple_sort))

        log.logger.debug(
            str("小於5天的幣數量:"+str(len(data_symbol_less_than_five_day))))
